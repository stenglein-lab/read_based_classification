// This process defined as part of the taxprofiler nf-core pipeline, so 
// is not a traditional nf-core module
// https://github.com/nf-core/taxprofiler/blob/1.1.2/modules/local/krona_cleanup.nf
